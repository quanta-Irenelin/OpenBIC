...
sensor_cfg plat_sensor_config[] = {
	...
	{ SENSOR_NUM_TEMP_CXL, sensor_dev_pm8702, I2C_BUS2, NONE, 0x01,
	...
	{ SENSOR_NUM_TEMP_DIMMA, sensor_dev_pm8702, I2C_BUS2, NONE, 0x05,
	  dc_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, DISABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &receiver_info[0] },
	{ SENSOR_NUM_TEMP_DIMMB, sensor_dev_pm8702, I2C_BUS2, NONE, 0x05,
	  dc_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &receiver_info[0] },
	{ SENSOR_NUM_TEMP_DIMMC, sensor_dev_pm8702, I2C_BUS2, NONE, 0x01,
	  dc_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, DISABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &receiver_info[0] },
	{ SENSOR_NUM_TEMP_DIMMD, sensor_dev_pm8702, I2C_BUS2, NONE, 0x01,
	  dc_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, DISABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &receiver_info[0] },
