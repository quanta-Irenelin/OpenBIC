...
sensor_cfg plat_sensor_config[] = {
	...
	{ SENSOR_NUM_TEMP_DIMMA, sensor_dev_pm8702, CXL_EID, DIMMA_TEMP_ADDR, dimm_temp_from_pioneer,
	...
	{ SENSOR_NUM_TEMP_DIMMB, sensor_dev_pm8702, CXL_EID, DIMMB_TEMP_ADDR, dimm_temp_from_pioneer,
	  dc_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, pre_pm8702_read, NULL, post_pm8702_read, NULL, &pm8702_dimm_init_args[0] },
	{ SENSOR_NUM_TEMP_DIMMC, sensor_dev_pm8702, CXL_EID, DIMMC_TEMP_ADDR, dimm_temp_from_pioneer,
	  dc_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, pre_pm8702_read, NULL, post_pm8702_read, NULL, &pm8702_dimm_init_args[3] },
	{ SENSOR_NUM_TEMP_DIMMD, sensor_dev_pm8702, CXL_EID, DIMMD_TEMP_ADDR, dimm_temp_from_pioneer,
	  dc_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
